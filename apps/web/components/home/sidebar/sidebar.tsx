...
export default function Sidebar() {
  ...
  return (
    <aside className="w-60 h-full p-5 bg-gradient-to-b from-[#6F42C1] to-[#8B5CF6] text-white shadow-xl">
      {/* User Section */}
      <div className="mb-6 p-4 rounded-xl bg-white/10 backdrop-blur-lg border border-white/20 animate-pulse">
      ...
      <div 
        role="button"
        tabIndex={0}
        className="p-3 ahadow-md rounded-lg mb-3 cursor-pointer transition-all bg-white/5 hover:bg-white/20 border border-white/10"
      >
        <span className="font-medium">🗑 Remove site</span>
      </div>
